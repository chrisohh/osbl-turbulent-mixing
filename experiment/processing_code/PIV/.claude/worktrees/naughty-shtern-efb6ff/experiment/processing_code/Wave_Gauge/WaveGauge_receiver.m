...
WAVEGAUGE_CHANNEL = 'ai7';       % Wave gauge connected to AI0
WAVEGAUGE_CALIBRATION = 0.2;     % V/cm (from amplifier)

% Trigger Settings
USE_TRIGGER = false;              % Set to false to test without trigger
...
still_water_voltage = 0;%mean(voltage(1:min(100, length(voltage))));
